...
export default async function CatalogLearningDetailPage({
  params,
  searchParams,
}: PathDetailPageProps) {
  noStore();
    ...
    <main className="min-h-screen bg-black px-6 py-14 text-white sm:py-16">
      <div className="mx-auto max-w-6xl space-y-10">
        <section className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
          <PageHero
            backHref="/tools/firearm-catalog/learning"
            backLabel="Back to learning journeys"
          ...
          <div className="space-y-5">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <SurfaceCard className="space-y-3">
                ...
                {previousItem ? (
                  <Link
                    href={`/tools/firearm-catalog/learning/${path.slug}?step=${step - 1}`}
